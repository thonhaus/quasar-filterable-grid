...
function extendConf (conf, api) {
  ...
  conf.boot.push('~quasar-app-extension-filterable-grid/src/boot/register-component.js')

  if (api.hasVite !== true) {
    // make sure boot & component files get transpiled
    conf.build.transpileDependencies.push(/quasar-app-extension-filterable-grid[\\/]src/)
  }
}
